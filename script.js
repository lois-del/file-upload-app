const input = document.getElementById('fileFormat')
...
selectedFile.addEventListener('click', function(){
   console.log('Clicked')
   fileFormats.push(selectedFile.textContent)
...
function addRow(){
    var table = document.getElementById('configurationsTable');
...
function autocomplete(inp, arr) {
  ...
  autocomplete(document.getElementById("templateGroup"), templateGroup);
